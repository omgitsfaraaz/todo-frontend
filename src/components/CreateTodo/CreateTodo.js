  ...
  return (
    <div className={styles.mainDiv}>
        ...
        <div className={styles.modalBody}>
            <input className={styles.todoInput} type="text" onChange={(e) => setTodoTitle(e.target.value)} placeholder='Your todo...' />
            <button className={styles.todoBtn} onClick={createTodoSubmit}>Create Todo</button>
        </div>
